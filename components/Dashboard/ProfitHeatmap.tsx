...
const HOURS = Array.from({ length: 12 }, (_, i) => i + 9); // 9am to 8pm (20:00)
...
const ProfitHeatmap: React.FC = () => {
  ...
  const handleOptimize = () => {
      ...
      // Simula el tiempo de procesamiento de n8n / AI
      setTimeout(() => {
                    ...
                    <div className="p-6">
                        <div className="bg-indigo-50 dark:bg-indigo-900/10 border border-indigo-100 dark:border-indigo-500/20 rounded-xl p-4 mb-6">
                            <p className="text-gray-700 dark:text-gray-300 text-sm leading-relaxed">
                                ...
                                <br/><br/>
                                📉 Detecté un patrón crítico de <span className="font-bold text-rose-500">Zonas Muertas</span> los <span className="underline decoration-rose-500 decoration-2">Martes por la mañana</span> (9am - 12pm) donde la ocupación es inferior al 10%.
                            </p>
                        </div>
                        ...
                        <button 
                            onClick={() => {
                                setShowModal(false);
                                alert("🚀 Campaña enviada exitosamente a la cola de procesamiento.");
                            }}
                            className="w-full mt-8 bg-black dark:bg-white text-white dark:text-black py-3 rounded-xl font-bold text-sm hover:opacity-90 transition-opacity shadow-lg"
                        >
