...
import { ArrowRightLeft, Gift, CheckCircle, Clock, Loader2, ChevronLeft, ChevronRight } from 'lucide-react';
...
const RedemptionHistory: React.FC<RedemptionHistoryProps> = ({
    ...
    const totalItems = sortedRedemptions.length;
    const totalPages = Math.ceil(totalItems / maxItems);
    const startIndex = (currentPage - 1) * maxItems;
    const displayedRedemptions = sortedRedemptions.slice(startIndex, startIndex + maxItems);
