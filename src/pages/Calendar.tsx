    ...
    <div className={`overflow-x-hidden ${isFullScreen ? 'fixed inset-0 z-[100] bg-gray-50 dark:bg-dark-bg px-0 pt-2 pb-6 sm:p-6 flex flex-col gap-3 h-[100dvh]' : 'space-y-4 pb-24 sm:pb-4'}`}>
      ...
      <div className="flex flex-col gap-2.5 px-4 sm:px-0">
        <div className="flex items-center gap-1.5 w-full">
          ...
          <div className="flex-1 grid grid-cols-3 gap-1 bg-gray-100 dark:bg-gray-800/80 rounded-2xl p-1 h-[46px] sm:h-[52px]">
            {([
              { view: 'list' as const,    label: 'Lista',   icon: <List size={16} />,         featureKey: null },
              { view: 'monthly' as const, label: 'Mensual', icon: <Grid3X3 size={16} />,      featureKey: null },
              { view: 'columns' as const, label: 'Staff',   icon: <CalendarIcon size={16} />, featureKey: 'staff' },
              ...
              return (
                <button
                  ...
                  className={`
                    ...
                    transition-all duration-200 active:scale-95 min-h-[38px]
                    ${!hasAccess
                ...
                >
                  ...
                  <span className="text-xs sm:text-[11px] md:text-sm">{label}</span>
                </button>
              );
            })}
          ...
          <div className="flex gap-1.5 h-[46px] sm:h-[52px]">
            <button
              onClick={() => setIsFullScreen(!isFullScreen)}
              className="flex items-center justify-center aspect-square h-full rounded-2xl border border-gray-200 bg-white text-gray-500 hover:bg-gray-50 dark:border-dark-border dark:bg-dark-card dark:text-gray-300 active:scale-95 transition-all shadow-sm min-w-[44px]"
            ...
            <button
              onClick={refresh}
              disabled={isLoading}
              className="flex items-center justify-center aspect-square h-full rounded-2xl border border-gray-200 bg-white text-gray-500 hover:bg-gray-50 dark:border-dark-border dark:bg-dark-card dark:text-gray-300 active:scale-95 transition-all shadow-sm disabled:opacity-50 min-w-[44px]"
        ...
        {calendarViewType === 'list' && (
          <div className="flex gap-2">
            <button
              ...
              className={`flex-1 flex items-center justify-center gap-2 px-3 py-2.5 text-xs sm:text-sm font-bold rounded-xl transition-all active:scale-95 min-h-[44px] ${viewMode === 'upcoming'
                ? 'btn-primary text-white shadow-md shadow-brand/20'
            ...
            >
              ...
              Próximas
              <span className={`rounded-full px-2 py-0 text-[10px] font-black ${viewMode === 'upcoming' ? 'bg-white/25 text-white' : 'bg-gray-100 dark:bg-gray-800 text-gray-600 dark:text-gray-300'
                }`}>
                {(() => {
            ...
            <button
              ...
              className={`flex-1 flex items-center justify-center gap-2 px-3 py-2.5 text-xs sm:text-sm font-bold rounded-xl transition-all active:scale-95 min-h-[44px] ${viewMode === 'history'
                ? 'bg-gradient-to-r from-gray-700 to-gray-900 text-white shadow-md shadow-gray-900/20 dark:from-gray-600 dark:to-gray-800'
      ...
      {calendarViewType === 'list' && (
        <div className="mx-4 sm:mx-0 flex flex-col gap-2.5 rounded-2xl bg-white p-3 shadow-sm sm:flex-row sm:items-center dark:bg-dark-card border border-gray-100 dark:border-dark-border">
          <div className="relative flex-1">
            ...
            <input
              ...
              className="w-full rounded-xl bg-gray-50 py-2.5 pl-10 pr-4 text-sm outline-none focus:ring-2 focus:ring-primary/50 dark:bg-dark-bg dark:text-white min-h-[44px]"
            />
          </div>
          <div className="flex items-center gap-2 overflow-x-auto pb-1 sm:pb-0 scrollbar-hide">
            <div className="flex items-center shrink-0 text-gray-400 pl-1">
              <ListFilter size={16} />
            </div>
            <select
              value={filterStatus}
              onChange={(e) => setFilterStatus(e.target.value)}
              className="rounded-xl bg-gray-50 px-3 py-2.5 text-xs sm:text-sm outline-none focus:ring-2 focus:ring-primary/50 dark:bg-dark-bg dark:text-white cursor-pointer min-w-[140px] min-h-[44px]"
            >
            ...
            <select
              ...
              className="rounded-xl bg-gray-50 px-3 py-2.5 text-xs sm:text-sm outline-none focus:ring-2 focus:ring-primary/50 dark:bg-dark-bg dark:text-white cursor-pointer min-w-[150px] min-h-[44px]"
            >
