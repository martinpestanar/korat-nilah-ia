...
const DEFAULT_STORE_ITEMS: AddonItem[] = [
  // ─── COMBOS & PLANES ───
  {
    ...
    precioUsd: 100,
    precioPen: 335,
    precioRegularUsd: 170,
    precioRegularPen: 570,
    tipoCobro: '/mes',
    subtitulo: 'Sistema automático completo para retención, citas y ventas por WhatsApp.',
    dolorQueResuelve: 'Elimina el trabajo manual de agendar, recordar citas y reactivar clientas que no regresan.',
    beneficios: [
      'Recordatorios automáticos 24h y 3h por WhatsApp con confirmación',
      'Rescate inteligente de clientas inactivas (45d/75d/120d)',
      'Disparador automático de retoque de pestañas y uñas (15-21 días)',
      'Campañas de marketing masivo por WhatsApp para días flojos',
      'Encuestas de satisfacción post-cita y Club de Puntos VIP',
      'Kit QR de mostrador para Reseñas 5★ en Google Maps + App Cupones',
      'Capacidad de clientas y citas 100% ILIMITADAS',
      'Instalación y soporte asistido directo con Martín en 24h',
    ],
    comoFunciona: [
      'Activamos todas las automatizaciones en tu cuenta en menos de 10 minutos.',
  ...
  // ─── WHATSAPP & AUTOMATIZACIONES ───
  {
    ...
    precioPen: 70,
    tipoCobro: '/mes',
    subtitulo: 'Recordatorios automáticos 24h y 3h antes con botón de confirmación en tiempo real.',
  ...
  {
    id: 'pack_retoques_21d',
    category: 'whatsapp',
    nombre: 'Disparador de Retoques Automático (15-21d)',
    emoji: '⏰',
    ...
    precioPen: 70,
    tipoCobro: '/mes',
    subtitulo: 'Avisa el retoque a los 15-21 días según servicio (pestañas, uñas, color).',
    dolorQueResuelve: 'Las clientas esperan al último momento para agendar su mantenimiento y luego no encuentran turno.',
    beneficios: [
      'Aviso inteligente al día 16 o 21 para cita de mantenimiento',
      'Aumenta 40% la frecuencia de visitas por clienta',
      'Mensaje amable y profesional con enlace a turnos libres',
      'Se paga solo con tan solo 1 retoque agendado al mes',
    ],
    comoFunciona: [
      'El sistema detecta los días transcurridos desde el último servicio.',
      'Envía una invitación personalizada recordando el mantenimiento.',
      'La clienta agenda su cita en segundos.',
    ],
    ejemploMensaje: '¡Hola Vale! 🌸 Ya pasaron 18 días desde tu set de pestañas pelo a pelo. ¿Te gustaría asegurar tu turno de retoque para esta semana? ✨',
    featureKey: 'retoques',
  },
  {
    id: 'pack_rescate_inactivas',
    category: 'whatsapp',
    nombre: 'Rescate de Clientas Dormidas (+45d)',
    emoji: '💸',
    badge: 'ALTO RETORNO',
    badgeType: 'highlight',
    precioUsd: 27,
    precioPen: 90,
    tipoCobro: '/mes',
    subtitulo: 'Filtra y reactiva a clientas que amaron tu trabajo pero no han vuelto hace +45 días.',
    dolorQueResuelve: 'El 60% de las clientas no regresan por falta de seguimiento. Hay dinero dormido en tu lista.',
    beneficios: [
      'Filtro automático de clientas sin visita en 45, 75 y 120 días',
      'Plantillas persuasivas con ofertas exclusivas de bienvenida',
      'Recupera de 5 a 15 clientas dormidas en la primera semana',
      'Control anti-spam inteligente para no saturar tu línea',
    ],
    comoFunciona: [
      'El sistema analiza la última visita de cada clienta en tu base de datos.',
      'Al cumplir los 45 días de ausencia, envía una invitación cordial.',
      'La clienta se reactiva y agenda su regreso.',
    ],
  ...
  // ─── MARKETING & VENTAS ───
  {
    ...
    category: 'marketing',
    nombre: 'Campañas Masivas de WhatsApp (Días Flojos)',
    emoji: '📢',
    ...
    precioPen: 120,
    tipoCobro: '/mes',
    subtitulo: 'Envía promociones y avisos segmentados a toda tu base en 1 solo clic.',
    dolorQueResuelve: 'Llena tus turnos vacíos de martes y miércoles con ofertas relámpago.',
    beneficios: [
    ...
    ejemploMensaje: '¡Hola Lucía! 🌸 Promo solo por hoy martes: *Lifting + Tinte con 25% OFF*. Solo 4 cupos disponibles. ¿Te guardamos uno?',
    featureKey: 'marketing',
  },
  {
    id: 'stand_qr_acrilico',
    category: 'marketing',
    nombre: 'Kit QR Reseñas 5★ Google Maps + Web App Cupones',
    emoji: '📍',
    badge: 'PRODUCTO + APP',
    badgeType: 'physical',
    precioUsd: 39,
    ...
    subtitulo: 'Stand para acrílico de mostrador + Web App interactiva de cupones de descuento.',
    dolorQueResuelve: 'Consigue que tus clientas felices dejen reseñas de 5 estrellas en tu perfil de Google Maps.',
    beneficios: [
      'Diseño personalizado en alta definición listo para stand acrílico de caja',
      'Mini Web App donde la clienta califica 5 estrellas en Google',
      'Generador de cupones de descuento automático para su próxima visita',
      'Posiciona tu salón en los primeros lugares de Google Maps en tu zona',
    ],
    comoFunciona: [
      'La clienta escanea el código QR desde su celular al pagar en caja.',
      'Registra su nombre y califica con 5 estrellas en tu Google Maps.',
      'Recibe su cupón de descuento en pantalla de inmediato.',
    ],
    isPhysical: true,
  },
  ...
  // ─── FIDELIZACIÓN & CUPOS ───
  {
    ...
    category: 'creative',
    nombre: 'Club de Puntos VIP & Calificaciones Post-Cita',
    emoji: '👑',
    ...
    precioPen: 90,
    tipoCobro: '/mes',
    subtitulo: 'Encuesta de calidad 2h post-cita + tarjeta de puntos digitales para consentir clientas VIP.',
    dolorQueResuelve: 'Asegura que tus clientas no se vayan con la competencia fidelizándolas con premios.',
    beneficios: [
      'Encuesta de satisfacción automática post-servicio por WhatsApp',
      'Puntos automáticos acumulables por cada visita o gasto',
  ...
  },
  {
    ...
    precioPen: 65,
    tipoCobro: '/mes',
    subtitulo: 'Amplía la capacidad de tu base de datos si superas las 100 clientas en plan básico.',
    ...
    beneficios: [
      ...
      'Conserva tu Plan Básico sin costo fijo alto',
              ...
              <div className="space-y-2.5 pt-4 border-t border-gray-100 dark:border-white/5">
                {owned ? (
                  ...
                  >
                    ...
                    <span>ACTIVAR (${item.precioUsd} USD · S/ {item.precioPen})</span>
                  </button>
                )}
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-violet-600 dark:text-violet-400 font-bold">
                      ${activeDetailsItem.precioUsd} USD (~ S/ {activeDetailsItem.precioPen} PEN) {activeDetailsItem.tipoCobro}
                    </p>
                  </div>
                </div>
                <button
