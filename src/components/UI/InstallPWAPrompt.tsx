...
const InstallPWAPrompt: React.FC = () => {
  ...
  useEffect(() => {
    ...
    // Only show on Dashboard or Inbox, not login/registration
    const validPaths = ['/dashboard', '/inbox'];
    if (validPaths.some(path => location.pathname.includes(path))) {
  ...
  }, [isInstallable, isInstalled, location.pathname]);
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-gray-500 dark:text-gray-400 mb-3">
                Agrega Nilah a tu pantalla de inicio para notificaciones y acceso offline. Es ultra rápida.
              </p>
