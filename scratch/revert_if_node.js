...
if (estaActivadoNode) {
  estaActivadoNode.parameters.conditions.conditions = [
    {
      ...
      "leftValue": "={{ $json.recursos_saas.automatizaciones.mantenimiento_activo }}",
      "rightValue": true,
      "operator": {
        "type": "boolean",
        "operation": "equals"
    ...
    },
    {
      ...
      "leftValue": "={{ $json.recursos_saas.automatizaciones.permitir_mantenimiento }}",
      "rightValue": true,
      "operator": {
        "type": "boolean",
        "operation": "equals"
  ...
  console.log('Reverted "Esta activado?" node paths successfully!');
}
