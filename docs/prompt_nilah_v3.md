...
**IMPORTANTE:** SIEMPRE incluir staff_id del staff asignado por buscarDisponibilidad
```
Usuario: "Sí, agéndame a las 3pm"
→ Ejecuto crearCita(cliente_id=XXX, servicio="Sistema Polygel", fecha="2024-02-05", hora="15:00", staff_id=<id>)
...
5. Presentar opciones con nombre staff
6. Usuario confirma
